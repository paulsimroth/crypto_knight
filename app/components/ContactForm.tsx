                ...
                <form id="contact-form">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
                        ...
                        <div className="flex items-center space-x-2 mx-1">
                            ...
                            >
                                I confirm that I have read and agreed to the <Link href="https://www.paulsimroth.at/datapolicy" className='underline underline-offset-4 text-primary' aria-label="Link to Data Policy">Data Policy.</Link>
                            </label>
                        </div>
                    </div>
                </form>
