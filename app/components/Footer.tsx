    ...
    return (
        <div className="w-full h-28  bottom-0 flex items-center justify-between bg-secondary px-10">
            ...
            <div className="flex flex-col md:flex-row items-start w-fit max-w-1/3">
                <Link href={"https://www.paulsimroth.at/imprint"} className="underline m-2" target="_blank" onClick={() => event("main_page", "legal", "imprint")}>
                    Imprint
                </Link>
                <Link href={"https://www.paulsimroth.at/datapolicy"} className="underline m-2" target="_blank" onClick={() => event("main_page", "legal", "datapolicy")}>
                    Datapolicy
                </Link>
            </div>
        </div>
